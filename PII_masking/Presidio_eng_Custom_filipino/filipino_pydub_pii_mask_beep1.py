...
class FilipinoPIIMasker:
    def __init__(self, surname_file: str = "filipino_surnamess.txt"):
        ...
        # Define PII patterns for Filipino text (only FIGURE, PERSON relies on surname file)
        self.pii_patterns = [
            {
                "entity": "FIGURE",
    ...
    def mask_transcription(self, transcription: List[Dict]) -> List[Dict]:
        ...
        for entry in transcription:
            ...
            # Step 2: Regex-based matching (for FIGURE only)
...
def main():
    ...
    transcription_path = "test_audi_trans_philipino/Fifth_test/3db7d20f-d40b-4750-9908-baf097fecdec_outbound-09772696858-2000047-20250220-161006-3286917.outbound-09772696858-2000047-20250220-161006-3286917_612746791864_2_11_.json"
    audio_path = "test_audi_trans_philipino/Fifth_test/3db7d20f-d40b-4750-9908-baf097fecdec_outbound-09772696858-2000047-20250220-161006-3286917.outbound-09772696858-2000047-20250220-161006-3286917_612746791864_2_11_.wav"
    beep_path = "beep.wav"
