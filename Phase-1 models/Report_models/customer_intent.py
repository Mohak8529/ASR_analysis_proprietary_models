...
def process_serialized_transcription(serialized_transcription: List[Dict]) -> Dict:
    sentiment, sentiment_scores, _ = get_sentiment_score(serialized_transcription)
    cooperation, _ = get_cooperation_level(serialized_transcription)
    resolution, _ = get_resolution_level(serialized_transcription)
    entity_scores, _ = get_entity_score(serialized_transcription)
    relevance_scores, _ = get_contextual_relevance(serialized_transcription)
