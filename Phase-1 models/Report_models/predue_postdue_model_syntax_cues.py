...
with open('Payment Plan - Approved_Baby Lou Tarin_Alvin Marquez Sanchez_616948360659_2025-01-16_09.18.50.json', 'r') as file:
...
# Function to calculate days overdue (unchanged)
...
# Criteria evaluation function with enhancements
def evaluate_criteria(transcription: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        if date_match:
            ...
            if "/" not in call_date_str:
                if any(month in call_date_str.lower() for month in valid_months):
                    ...
                    continue  # Skip if no valid month
    ...
    if call_date_str and due_date_str:
        ...
        # Expanded keyword lists with fuzzy matching
        pre_due_keywords = [
        ...
        post_due_general_keywords = [
            ...
            "failure to pay may result", "payment plan for the overdue", "behind on payment"
        ]
        ...
        # High-priority keywords with fuzzy matching (85% threshold)
        ...
        for entry in transcription:
            ...
            # General fuzzy matching
                ...
                collection_type = "Postdue Collections Less Than 30 days"
                break
            elif evaluate_fuzzy_match(dialogue, post_due_general_keywords):
                collection_type = "Postdue Collections Less Than 30 days"
                break
    ...
    # Extract customer details (unchanged)
    for entry in transcription:
        dialogue = entry["dialogue"]
