...
# Load model
class TranslationTransformer(nn.Module):  # Same as in train_model.py
...
# Beam search (inspired by SeamlessM4T)
...
# Example translation
call_transcript = "Magandang umaga, kamusta ka? I'm good, ikaw?"
translated = beam_search(model, call_transcript, sp)
print(f"Input: {call_transcript}")
